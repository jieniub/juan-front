      ...
      <section class="c-sort-box">
        ...
        <div class="js-wrap">
          ...
          <section class="fl">
            <ol class="js-tap clearfix">
              <li :class="{ 'current bg-orange': searchObj.startNumSort != 0 }">
                <a
                  title="最热"
                  href="javascript:void(0);"
                  @click="searchstartNum()"
                  >最热
                  <span :class="{ hide: searchObj.startNumSort == 0 }">↓</span>
                </a>
              </li>
              <li
                :class="{ 'current bg-orange': searchObj.gmtCreateSort != 0 }"
              >
                <a
                  title="最新"
                  href="javascript:void(0);"
                  ...
                  >最新
                  <span :class="{ hide: searchObj.gmtCreateSort == 0 }">↓</span>
                </a>
              </li>
            </ol>
          </section>
                ...
                <div class="cc-l-wrap">
                  ...
                  <section class="mt10 hLh20 of">
                    ...
                    <span class="fl jgAttr c-ccc f-fA">
                      <i class="c-999 f-fA">{{ item.startNum }}人学习</i>
                      |
        ...
        <div>
          <div class="paging">
            ...
            >
            <a
              :class="{ undisable: page == pages }"
              href="#"
              title="后一页"
              @click.prevent="gotoPage(page + 1)"
              >&gt;</a
            >
            <a href="#" title="末页" @click.prevent="gotoPage(pages)">末</a>
            <div class="clear" />
          </div>
        </div>
        <!-- 公共分页 结束 -->
  ...
  methods: {
    ...
    initCourse() {
      course.getPageList(1, 8, this.searchObj).then((response) => {
        ...
        this.pages = Math.floor(this.data.total / 8);
        if (this.data.total / 8 != 0) {
          this.pages += 1;
        }
      });
    },
    ...
    searchstartNum() {
      ...
      this.searchObj.startNumSort = 1;
      this.searchObj.gmtCreateSort = 0;
      this.gotoPage(this.page);
    },
    //更新时间查询
    searchGmtCreate() {
